  ...
  return (
    <div className="space-y-6">
      ...
      {isLoadingStats ? (
        ...
        stats.totalMembers === 0 && stats.totalUsers > 0 ? (
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">No members found</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>You have {stats.totalUsers} user account(s) but no members have been added yet.</p>
                  <p className="mt-2">
                    <a href="/members/new" className="font-medium text-blue-600 hover:text-blue-500">
                      Add your first member <span aria-hidden="true">&rarr;</span>
                    </a>
                  </p>
                </div>
              </div>
          ...
          <StatsGrid stats={{
            ...
            membershipRenewals: stats.membershipRenewals,
          }} />
        )
      ) : (
